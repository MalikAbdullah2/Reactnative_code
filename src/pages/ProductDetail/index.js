...
import {Gap, Header, Label, List, Recomended, Strip} from '../../components';
import {colors, fonts} from '../../utils';

const images = [
  require('../../assets/illustration/Recomended-Image1.png'),
      ...
      <SafeAreaView style={styles.container}>
        ...
        <ScrollView>
            ...
            <View>
              <View style={styles.location}>
                <Text style={styles.deliveryTitle}>
                  Khulna, Jashore, Noapara
                </Text>
                <ICLocation marginLeft={20} />
              </View>
              <View style={styles.location}>
                <Text style={styles.homeDelivery}>
                  Home Delivery, 5 - 10 days
                </Text>
                <Text style={styles.homeDelivery}>৳ 60</Text>
              </View>
            </View>
          ...
          {/* <View style={styles.delivery}>
            ...
            <View>
              <Text style={styles.homeDelivery}>- 7 Day Return</Text>
              <Text style={styles.homeDelivery}> change of mind available</Text>
              <Text style={styles.homeDelivery}>- Warranty not available</Text>
            </View>
            <Image source={ICGo} style={styles.go} marginLeft={40} />
          </View>
          <Gap height={20} />
          <View style={styles.stripGap} />
          <View style={styles.gap} />
          ...
          <View style={styles.wrapperReview}>
            <List
              avatar={DummyAvatar1}
              date="18 Nov 2020"
              desc="Item delivered in good condition. I will recommended to other buyer."
            />
            <List
              avatar={DummyAvatar2}
              date="18 Nov 2020"
